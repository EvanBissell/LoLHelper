...
public class items {
	...
	public static void runMain(){
		...
		itemsArray[1] = new items("Aegis of the Legion",
		itemsArray[2] = new items("Aether Wisp",
		itemsArray[3] = new items("Amplifying Tome", 
		itemsArray[4] = new items("Ancient Coin",
		itemsArray[5] = new items("Archangel's Staff"
		...
		itemsArray[8] = new items("Augment: Death",
		itemsArray[9] = new items("Augment: Gravity",
		itemsArray[10] = new items("Augment: Power",
		itemsArray[11] = new items("B.F. Sword",
		...
		itemsArray[14] = new items("Berserker's Greaves", "Common", "Advanced", "+20% atttack speed", "Unique - Enhanced Movement: +45 movement speed", null, null, null, null, "Attack > Attack Speed \nMovement", "900g (175g)", "630g");
		...
		itemsArray[23] = new items("Boots of Mobility", "Common", "Advanced", null, "Unique - Enhanced Movement: +25 movement speed. Increases to +105 movement speed when out of combat for 5 seconds.", null, null, null, null, "Movement", "800g (475g)", "560g");
		itemsArray[24] = new items("Boots of Speed",
		itemsArray[25] = new items("Boots of Swiftness", "Common", "Advanced", null, "Unique - Enhanced Movement: +60 movement speed.", "Unique - Slow Resist: Movement slowing effects are reduced by 25%", null, null, null, "Movement", "1000g (675g)", "700g");
		...
		itemsArray[81] = new items("Last Whisper", "Common", "Advanced", "+40 attack damage", "Unique: +35% armor penetration", null, null, null, null, "Attack > Damage", "2300g (1065g)", "1610g");
		...
		itemsArray[94] = new items("Mercury's Treads", "Common", "Advanced", "+25 magic resistance", "Unique - Enhanced Movement: +45 movement speed", "Unique - Tenacity: the duration of stuns, slows, taunts, fears, silences, blinds, and immobilizes are reduced by 35%.", null, null, null, "Defense > Magic Resist \nMovement", "1200g (475g)", "840g");
		...
		itemsArray[101] = new items("Ninja Tabi", "Common", "Advanced", "+25 armor", "Unique - Enhanced Movement: +45 movement speed.", "Unique: Blocks 10% of the damage from basic attacks.", null, null, null, "Defense > Armor \nMovement", "1000g (375g)", "700g");
		itemsArray[102] = new items("Nomad's Medallion",
		itemsArray[103] = new items("Null-Magic Mantle",
		...
		itemsArray[126] = new items("Runaan's Hurricane", "Common", "Advanced", "+70% attack speed", "Ranged only: Unique Passive: your basic attacks fire minor bolts at 2 nearby targets, each dealing 10 (+50% AD) physical damage and applying on-hit effects.", null, null, null, null, "Attack > Attack Speed", "2400g (700g)", "1680g");
		...
		itemsArray[135] = new items("Sorcerer's Shoes", "Common", "Advanced", "+15 magic penetration", "Unique - Enhanced Movement: +45 movement speed.", null, null, null, null, "Movement", "1100g (775g)", "770g");
		...
		itemsArray[165] = new items("Void Staff", "Common", "Advanced", "+70 ability power", "Unique: +35% magic penetration", null, null, null, null, "Magic > Ability Power", "2295g (1000g)", "1607g");
		itemsArray[166] = new items("Warden's Mail",
		itemsArray[167] = new items("Warding Totem",
		itemsArray[168] = new items("Warmog's Armor", "Summoner's Rift", "Advanced", "+1000 health", "Unique Passive: You gain health regeneration equal to 1% of your maximum health.", null, null, null, null, "Defense > Health \nDefense > Health Regen", "2830g (1070g)", "1981g");
